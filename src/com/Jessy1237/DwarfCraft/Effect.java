...
public class Effect {
	...
	protected String describeLevel(DCPlayer dCPlayer) {
		...
		case EAT: 
			description = String.format(
					"&6You gain %s%.2f &6Food Level (not &e%.2f&6) when you eat &2%s",
	...
	public boolean checkMob(Entity entity){
		...
		switch (mCreature){
			...
			case MUSHROOM_COW: return (entity instanceof MushroomCow);
			case SILVERFISH:   return (entity instanceof Silverfish);
			case ENDERMAN:     return (entity instanceof Enderman);
			case VILLAGER:     return (entity instanceof Villager);
			case BLAZE:        return (entity instanceof Blaze);
			case MAGMA_CUBE:   return (entity instanceof MagmaCube);
			case CAVE_SPIDER:  return (entity instanceof CaveSpider);
			case SNOWMAN:      return (entity instanceof Snowman);
			case ENDER_DRAGON: return (entity instanceof EnderDragon);
