...
public class DwarfCraftLevelUpEvent extends Event implements Cancellable
{
	...
	/**
	 * The event for when a DCPlayer levels up their skill. This event is
	 * fired after the skill is levelled but before the data is saved.
	 * 
	 * @param player
	 ...
	 */
	public DwarfCraftLevelUpEvent(DCPlayer player, DwarfTrainer trainer,
			Skill skill)
	{
		this.player = player;
