...
public class DwarfCraftEffectEvent extends Event implements Cancellable
{
	 ...
	 *            alters/adds
	 * @param origHunger
	 *            The original hunger added to the player before the effect.
	 *            Put null if the players hunger is not altered
	 * @param newHunger
	 ...
	 *            the event, can also be damage done to a tool. Put null if
	 *            the damage is not altered
	 * @param newDmg
	 ...
	 *            broken or the block that contains the inventory used. Put
	 *            null if no block is involved in the event.
	 * @param itemInHand
	 *            The item that was in the hand of the player and that also
	 *            allowed the effect to fire. i.e. a sword when killing an
	 *            entity.
	 */
	public DwarfCraftEffectEvent(DCPlayer player, Effect effect,
			ItemStack[] orig, final ItemStack[] altered, Integer origHunger,
			Integer newHunger, Double origDmg, Double newDmg, Entity entity,
	...
	/**
	 * Gets the players added original hunger before the effect was fired.
	 * Will return null if the effect doesn't alter the players hunger.
	 * 
	 * @return Integer
	 */
	 ...
	 * 
	 * @param newHunger
	 *            The altered hunger of the player after the effect takes
	 *            place.
	 * 
	 */
	...
	/**
	 * Gets the original damage taken by or given by the player, can also be
	 * the damage to a tool. Will return null if the effect doesn't alter
	 * damage.
	 * 
	 * @return Integer
	 */
	...
	/**
	 * Gets the altered damage taken by or given by the player, can also be
	 * the damage to a tool. Will return null if the effect doesn't alter
	 * damage.
	 * 
	 * @return Integer
	...
	/**
	 * Sets the altered damage taken by or given by the player, can also be
	 * the damage to a tool. If the effect doesn't altered damage then
	 ...
	 * involved with the effect other then the player then this will return
	 * null
	 * 
	 * @return Entity
	 */
	 ...
	 * item in hand didn't help fire the effect of if the player didn't have
	 * an item in hand
	 * 
	 * @return ItemStack
	 */
